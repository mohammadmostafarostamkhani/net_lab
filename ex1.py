...
def run():
    ...
    info('\n** Adding Hosts\n')
    r1 = net.addHost('r1', ip='10.38.70.5/24', hostname='r1')
    h1 = net.addHost('h1', ip='10.38.70.1/24', hostname='h1')
    h2 = net.addHost('h2', ip='10.38.70.2/24', hostname='h2')
    h3 = net.addHost('h3', ip='10.38.56.3/24', hostname='h3')
    h4 = net.addHost('h4', ip='10.38.56.4/24', hostname='h4')
    ...
    h1.cmd('ip addr add 10.38.70.1/24 dev h1-eth0')
    h2.cmd('ip addr add 10.38.70.2/24 dev h2-eth0')
    h3.cmd('ip addr add 10.38.56.3/24 dev h3-eth0')
    h4.cmd('ip addr add 10.38.56.4/24 dev h4-eth0')

    h1.cmd('ip route add default via 10.38.70.5')
    h2.cmd('ip route add default via 10.38.70.5')
    h3.cmd('ip route add default via 10.38.56.5')
    h4.cmd('ip route add default via 10.38.56.5')
    ...
    # r1.cmd('ifconfig r1-eth0 10.38.80.5 netmask 255.255.255.0')
    r1.cmd('ifconfig r1-eth1 10.38.56.5 netmask 255.255.255.0')
    ...
    # 10.38.56.3 -> h3
    # 10.38.70.5 -> r1-eth0
    h1.cmd('iptables -t nat -A POSTROUTING -d 10.38.56.3 -j SNAT --to 10.38.70.5')
    # 10.38.56.3 -> h3
    # 10.38.70.5 -> r1-eth0
    # 10.38.56.4 -> h4
    r1.cmd('iptables -t nat -A PREROUTING -d 10.38.56.3 -s 10.38.70.5 -j DNAT --to 10.38.56.4')
